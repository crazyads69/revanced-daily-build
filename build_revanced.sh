...
if [ -f "com.google.android.youtube.apk" ]; then
    java --rip-lib x86_64 --rip-lib x86 -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar --mount \
...
if [ -f "com.google.android.youtube.apk" ]; then
    java --rip-lib x86_64 --rip-lib x86 -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar \
        ${patches[@]} \
        $EXPERIMENTAL \
...
if [ -f "com.google.android.apps.youtube.music.apk" ]; then
    ...
    java --rip-lib x86_64 --rip-lib x86 -jar revanced-cli.jar -b revanced-patches.jar --mount \
        -e microg-support ${patches[@]} \
        $EXPERIMENTAL \
...
if [ -f "com.google.android.apps.youtube.music.apk" ]; then
    ...
    java --rip-lib x86_64 --rip-lib x86 -jar revanced-cli.jar -b revanced-patches.jar \
        ${patches[@]} \
        $EXPERIMENTAL \
...
if [ -f "com.zhiliaoapp.musically.apk" ]; then
    echo "Building Non-root APK"
    java --rip-lib x86_64 --rip-lib x86 -Xmx8192m -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar \
        ${patches[@]} \
        $EXPERIMENTAL \
